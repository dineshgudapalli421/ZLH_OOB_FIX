		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "OOB Fix Tool",
									"targetURL": "#comsaplhmrzlhoobfix-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsaplhmrzlhoobfix-display": {
								"semanticObject": "comsaplhmrzlhoobfix",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.lh.mr.zlhoobfix",
									"url": sap.ui.require.toUrl("com/sap/lh/mr/zlhoobfix")
								}
							}
						}
					}
